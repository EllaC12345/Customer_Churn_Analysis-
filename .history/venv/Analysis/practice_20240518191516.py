...
device_protection_df\
    ...
    .agg({'count': 'sum'})\
    .reset_index()\
    .pivot(index='DeviceProtection', columns='Churn', values='count')\
    .plt(kind='bar', stacked=True, x='DeviceProtection', y = 'count', color = 'Churn', title="Customer Churn Rate by Device Protection Plan")
