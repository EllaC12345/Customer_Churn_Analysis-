...
numerical_cols = [column for column, in data_df.columns if data_df.select_dtypes(include=['int', 'float64'])]
numerical_cols

categorical_cols = [col for col,  in data_df.columns if data_df.select_dtypes(include =['object'])]
...
columns_with_datatypes = data_df.dtypes
