...
numerical_cols = [col for col, in data_df if data_df.select_dtypes(include=['int', 'float64'])]
numerical_cols

categorical_cols = [col for col,  in data_df if data_df.select_dtypes(include = ['int']) if dtype in ['object']]
