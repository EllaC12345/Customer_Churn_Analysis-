...
numerical_cols = [col for col, in data_df if data_df.select_dtypes(include=['object'] ['int', 'float64']]
numerical_cols

categorical_cols = [col for col, dtype in data_df.dtypes if dtype in ['object']]
