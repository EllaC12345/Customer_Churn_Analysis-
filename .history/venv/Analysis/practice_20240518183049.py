...
[churn_by_tenure] = df\
    .groupby("tenure_quartile", "Churn")\
    .agg(count("*").alias("count"))
    
churn_by_tenure = df.groupby("tenure_quartile",'churn' )["count"].sum()
fig = px.bar(df_sorted, x="tenure", y="count", color="Churn", title="Customer Churn Rate by Tenure") 
fig.show()  
#import pyspark
