...
df
px.bar(df, x="maxDepth", y=['test_accuracy','train_accuracy' ])
fig = px.bar(df, x="maxDepth", y=['test_accuracy','train_accuracy' ], title="Model Evaluation"
             )\
    .update_layout(xaxix={'categoryorder':'total descending'})
