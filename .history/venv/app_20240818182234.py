...
# DATA
churn_data_path = ART_PATH.joinpath("Data/churn_prediction_df.pkl")
resolved_churn_path = os.path.abspath(churn_data_path)
churn_data = pd.read_pickle(ART_PATH.joinpath(resolved_churn_path))
...
def download_strategy(n_clicks):
    if n_clicks is None:
        raise PreventUpdate
    return dcc.send_file("/Users/ellandalla/Desktop/Customer_Churn_Analysis-/venv/Data/recommendation.cs")
